#!/usr/bin/env bash
# ============================================================================
# Benchmark Experiment: MoT (Full Architecture, visual_gen=True)
# ============================================================================
# Purpose: Measure performance of full MoT with both understanding and generation branches
# Expected output: training_metrics.csv in output/benchmark_mot_vqa_1000steps/logs/
# ============================================================================
...
EXPERIMENT_NAME="benchmark_mot_1000steps_v2_mem_efficient"
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
num_gpus=8

# ===== File Paths =====
TRAIN_SCRIPT="${SCRIPT_DIR}/train/main_memory_efficient.py"  # Using benchmark version
...
echo "============================================================================"
echo "  Benchmark Experiment: MoT (Full Architecture)"
echo "============================================================================"
...
echo "       - freeze_mot_und: False (Understanding专家可训练)"
echo "       - freeze_mot_gen: False (Generation专家可训练)"
echo "       - total_steps: 500"
echo "       - expected_num_tokens: 12000 (SAME as baseline)"
echo "============================================================================"
...
# ===== Memory Optimization (如果遇到 OOM 错误) =====
# 取消下面这些行的注释并调整 torchrun 命令中对应的参数值：
# EXPECTED_NUM_TOKENS=8000   # 从 12000 减少到 8000
# MAX_NUM_TOKENS=10000        # 从 14000 减少到 10000
# MAX_TOKENS_PER_SAMPLE=9000  # 从 13000 减少到 9000
# CPU_OFFLOAD=True            # 启用 CPU offload（会降低速度但节省显存）
...
echo "============================================================================"
echo "[DONE] MoT experiment completed!"
