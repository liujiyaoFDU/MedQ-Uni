#!/usr/bin/env bash
# ============================================================================
# Loss Weight Sensitivity Experiment 2: Understanding-Moderate
# ============================================================================
# Purpose: Test moderate emphasis on understanding task
# Loss weights: ce_weight=2.0, mse_weight=1.0 (ratio 2:1)
# Expected: Good CE loss, moderate MSE loss
# ============================================================================
...
EXPERIMENT_NAME="sensitivity_exp2_ce2.0_mse1.0_1000steps_ver2"
...
echo "============================================================================"
echo "  Sensitivity Experiment 2: Understanding-Moderate (ce=2.0, mse=1.0)"
echo "============================================================================"
echo "[INFO] Experiment: ${EXPERIMENT_NAME}"
echo "[INFO] Loss weights: ce_weight=${CE_WEIGHT}, mse_weight=${MSE_WEIGHT} (ratio 2:1)"
echo "[INFO] Config file: ${CONFIG_FILE}"
echo "[INFO] Output directory: ${OUTPUT_DIR}"
echo "[INFO] Expected: Good CE loss, moderate MSE loss"
echo "============================================================================"
...
echo "============================================================================"
echo "[DONE] Experiment 2 completed!"
