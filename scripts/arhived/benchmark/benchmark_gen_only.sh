#!/usr/bin/env bash
# ============================================================================
# Benchmark Experiment: Generation-Only (visual_gen=True, visual_und=False)
# ============================================================================
# Purpose: Measure performance of pure generation model without understanding branch
# Expected output: training_metrics.csv in output/benchmark_gen_only_1000steps/logs/
# Key differences from MoT:
#   - visual_und=False: No VIT encoder, no understanding branch
#   - ce_weight=0.0: Only MSE Loss (generation task)
#   - Only T2I dataset (no VQA data)
# ============================================================================
...
EXPERIMENT_NAME="benchmark_gen_only_1000steps_ver2"
...
echo "============================================================================"
echo "  Benchmark Experiment: GENERATION-ONLY"
echo "============================================================================"
...
echo "============================================================================"
echo "[DONE] Generation-Only experiment completed!"
