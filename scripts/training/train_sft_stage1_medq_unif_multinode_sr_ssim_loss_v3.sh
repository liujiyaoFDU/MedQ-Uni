...
# ============================================================================
# Based on:
#   train_sft_stage1_medq_unif_multinode_sr_pixel_loss_small_max_T_small_pixel_weight.sh (infrastructure/data)
#   train_sft_stage1_medq_unif_multinode_eyeQ1_sr_ssim_loss.sh (SSIM loss config, validated)
# Changes:
#   - Replace pixel loss (L2) with SSIM loss for perceptual quality
#   - Use large-scale dataset (train_stage1_medq_unif_trainonly.yaml)
...
# ============================================================================
EXP_NAME="${1:-stage1_medq_2nodes_unif_sr_ssim_loss_v3}"  # Experiment name (v3: weight=0.1, max_t=0.1, grad_scale=0.01)
NUM_GPUS="${2:-8}"
MASTER_PORT="${3:-23456}"
...
echo "============================================================================"
echo "[INFO] Stage1 MedQ Unified Training (SR SSIM Loss v3)"
