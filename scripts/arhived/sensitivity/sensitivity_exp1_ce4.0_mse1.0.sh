#!/usr/bin/env bash
# ============================================================================
# Loss Weight Sensitivity Experiment 1: Understanding-Heavy
# ============================================================================
# Purpose: Test strong emphasis on understanding task
# Loss weights: ce_weight=4.0, mse_weight=1.0 (ratio 4:1)
# Expected: Best CE loss, higher MSE loss
# ============================================================================
...
EXPERIMENT_NAME="sensitivity_exp1_ce4.0_mse1.0_1000steps_ver2"
...
echo "============================================================================"
echo "  Sensitivity Experiment 1: Understanding-Heavy (ce=4.0, mse=1.0)"
echo "============================================================================"
echo "[INFO] Experiment: ${EXPERIMENT_NAME}"
echo "[INFO] Loss weights: ce_weight=${CE_WEIGHT}, mse_weight=${MSE_WEIGHT} (ratio 4:1)"
echo "[INFO] Config file: ${CONFIG_FILE}"
echo "[INFO] Output directory: ${OUTPUT_DIR}"
echo "[INFO] Expected: Best CE loss, higher MSE loss"
echo "============================================================================"
...
echo "============================================================================"
echo "[DONE] Experiment 1 completed!"
