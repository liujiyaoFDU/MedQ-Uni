#!/usr/bin/env bash
# ============================================================================
# Loss Weight Sensitivity Experiment 5: Generation-Heavy (Paper Setting)
# ============================================================================
# Purpose: Test strong emphasis on generation task (original paper setting)
# Loss weights: ce_weight=0.25, mse_weight=1.0 (ratio 1:4)
# Expected: Highest CE loss, best MSE loss
# ============================================================================
...
EXPERIMENT_NAME="sensitivity_exp5_ce0.25_mse1.0_1000steps_ver2"
...
# ===== File Paths =====
TRAIN_SCRIPT="${SCRIPT_DIR}/train/main_benchmark.py"
...
echo "============================================================================"
echo "  Sensitivity Experiment 5: Generation-Heavy [PAPER SETTING] (ce=0.25, mse=1.0)"
echo "============================================================================"
echo "[INFO] Experiment: ${EXPERIMENT_NAME}"
echo "[INFO] Loss weights: ce_weight=${CE_WEIGHT}, mse_weight=${MSE_WEIGHT} (ratio 1:4)"
echo "[INFO] Config file: ${CONFIG_FILE}"
echo "[INFO] Output directory: ${OUTPUT_DIR}"
echo "[INFO] Expected: Highest CE loss, best MSE loss"
echo "[INFO] ⭐ This is the ORIGINAL PAPER SETTING"
echo "============================================================================"
...
echo "============================================================================"
echo "[DONE] Experiment 5 completed!"
