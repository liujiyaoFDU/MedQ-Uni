#!/usr/bin/env bash
# ============================================================================
# Benchmark Experiment V2: Baseline VQA with Memory Efficient Training
# ============================================================================
# Purpose:
#   - 只训练Understanding任务（VQA）
#   - 使用新的参数管理机制精确冻结Generation分支
#   - 验证优化器只管理Understanding相关参数
# Key Improvements:
#   - freeze_mot_gen=True: 精确冻结MOT Generation专家
#   - print_param_details=True: 详细参数统计
#   - 使用main_memory_efficient.py训练脚本
# Expected Benefits:
#   - 更准确的显存占用统计
#   - 确保Generation参数不占用优化器状态空间
# ============================================================================
...
EXPERIMENT_NAME="benchmark_baseline_vqa_1000steps_v2_mem_efficient"
...
echo "============================================================================"
echo "  Benchmark Experiment V2: BASELINE VQA (Memory Efficient)"
echo "============================================================================"
...
echo "       - freeze_mot_gen: True (Generation专家被冻结)"
...
echo "============================================================================"
echo "[DONE] Baseline VQA V2 experiment completed!"
