#!/usr/bin/env bash
# ============================================================================
# Loss Weight Sensitivity Experiment 3: Balanced
# ============================================================================
# Purpose: Test balanced weighting between understanding and generation
# Loss weights: ce_weight=1.0, mse_weight=1.0 (ratio 1:1)
# Expected: Balanced CE and MSE loss
# ============================================================================
...
EXPERIMENT_NAME="sensitivity_exp3_ce1.0_mse1.0_1000steps_ver2"
...
echo "============================================================================"
echo "  Sensitivity Experiment 3: Balanced (ce=1.0, mse=1.0)"
echo "============================================================================"
echo "[INFO] Experiment: ${EXPERIMENT_NAME}"
echo "[INFO] Loss weights: ce_weight=${CE_WEIGHT}, mse_weight=${MSE_WEIGHT} (ratio 1:1)"
echo "[INFO] Config file: ${CONFIG_FILE}"
echo "[INFO] Output directory: ${OUTPUT_DIR}"
echo "[INFO] Expected: Balanced CE and MSE loss"
echo "============================================================================"
...
echo "============================================================================"
echo "[DONE] Experiment 3 completed!"
