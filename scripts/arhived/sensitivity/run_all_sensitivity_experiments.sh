...
SCRIPTS=(
    "scripts/sensitivity_exp1_ce4.0_mse1.0.sh"
    "scripts/sensitivity_exp2_ce2.0_mse1.0.sh"
    "scripts/sensitivity_exp3_ce1.0_mse1.0.sh"
    "scripts/sensitivity_exp4_ce0.5_mse1.0.sh"
    "scripts/sensitivity_exp5_ce0.25_mse1.0.sh"
...
bash scripts/sensitivity_exp1_ce4.0_mse1.0.sh
...
bash scripts/sensitivity_exp2_ce2.0_mse1.0.sh
...
bash scripts/sensitivity_exp3_ce1.0_mse1.0.sh
...
bash scripts/sensitivity_exp4_ce0.5_mse1.0.sh
...
bash scripts/sensitivity_exp5_ce0.25_mse1.0.sh
...
CSV_FILES=(
    "output/sensitivity_exp1_ce4.0_mse1.0_501steps/logs/training_metrics.csv"
    "output/sensitivity_exp2_ce2.0_mse1.0_501steps/logs/training_metrics.csv"
    "output/sensitivity_exp3_ce1.0_mse1.0_501steps/logs/training_metrics.csv"
    "output/sensitivity_exp4_ce0.5_mse1.0_501steps/logs/training_metrics.csv"
    "output/sensitivity_exp5_ce0.25_mse1.0_501steps/logs/training_metrics.csv"
)
